Changes for prism/Dolmexica:
Adds a parameter -a, which can be used to set the sector count of the audio track for Audio/Data images (was hardcoded to 302 in the original).
